...
(*
  ...
  регулирования вёл FB_TemperatureManager_v2.【F:docs/FB_Main_PR102.txt†L1-L36】

  FB_TemperatureManager_v3 реализует регулирование нагрева: поддержка режима
  ...
  выдаёт команды нагрева, процент мощности и фильтрованные температуры. Блок
  принимает булев сигнал разрешения нагрева и целевую температуру от
  пастеризатора, что упрощает стыковку между функциональными блоками.【F:docs/FB_TemperatureManager.txt†L1-L36】

  FB_PasteurManager отвечает за стадии HEAT, HOLD, COOL и управляет насосом
  циркуляции, мешалкой, клапанами охлаждения и разрешением нагрева.
  Обновлённый блок формирует целевую температуру для регулирования,
  передаёт булеву команду Pasteur_HeatEnable в температурный менеджер и
  публикует диагностические данные (номер стадии, длительность выдержки и
  маску этапов) для HMI.【F:docs/FB_PasteurManager.txt†L1-L33】
  ...
  мешалку CIP.【F:docs/FB_CIPManager.txt†L1-L38】
  ...
  команду на насос розлива.【F:docs/FB_DosingManager.txt†L1-L36】
  ...
  сброс и выдаёт абсолютный объём и приращение за шаг.【F:docs/FB_SoftFlowmeter.txt†L1-L36】
  ...
  Мешалка CIP управляется отдельным входом CIP_Mixer_ON.【F:docs/FB_ActuatorManager.txt†L1-L41】
  ...
  привода.【F:docs/FB_VFDManager.txt†L1-L39】
*)
...
// ============================================================================
(*
  Файл docs/config/Pasterizator_Стандартные_Переменные.csv описывает стандартные
  ...
  синхронизируются с HMI через сетевые регистры.【F:docs/config/Pasterizator_Стандартные_Переменные.csv†L1-L19】
*)
...
// ============================================================================
(*
  «docs/config/Pasterizator_Сетевые, Слот 1.csv» содержит карту регистров HMI: маски
  ...
  ограничения скорости мешалки (536).【F:docs/config/Pasterizator_Сетевые, Слот 1.csv†L1-L19】

  «docs/config/ПР102_Сетевые_Слот_2_Master_AD30_v4.csv» описывает связь со вторым слотом
  ...
  токов/напряжений. Все регистры помечены как Remote/VFD.【F:docs/config/ПР102_Сетевые_Слот_2_Master_AD30_v4.csv†L1-L14】
*)
...
// ============================================================================
(*
  Каталог docs разбит на подпапки: hardware для паспортов и схем оборудования,
  config для CSV-конфигураций и legacy для устаревших материалов. Актуальные
  инструкции по использованию legacy-файлов см. в docs/legacy/README.md.【F:docs/legacy/README.md†L1-L27】 Такой
  порядок упрощает поиск инженерной документации и контроль версий.
*)
